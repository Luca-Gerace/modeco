...
export default function Footer() {
    return (
        <footer className="w-full pt-12 mt-40 border-t-2">
            <div className="w-full px-8 mx-auto max-w-7xl">
                ...
                <div
                className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-blue-gray-50 md:flex-row md:justify-between">
                <p
                    className="block mb-4 font-sans text-sm antialiased font-normal leading-normal text-center text-blue-gray-900 md:mb-0">
                    © 2024{" "} by Luca Gerace. All Rights Reserved.
                </p>
                <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
                    <a href="https://www.linkedin.com/in/luca-gerace/"
                    target="_blank"
                    ...
                    <a href="https://github.com/Luca-Gerace/modeco"
                    target="_blank"
                    className="block font-sans text-base antialiased font-light leading-relaxed transition-opacity text-inherit opacity-80 hover:opacity-100">
                        <svg className="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
