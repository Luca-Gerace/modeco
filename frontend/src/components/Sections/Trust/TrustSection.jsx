...
export default function TrustSection() {
    ...
    return (
        <section className='w-full mt-8 px-0 imgBg min-h-[350px] relative'>
            <div className='text-white w-full py-16 px-6 lg:px-10 flex flex-col gap-12'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <p className='text-[18px] lg:text-[20px]'>
                        Essere il markeplace di riferimento per te e per tutti quelli che ci scelgono ogni giorno e che seguono uno stile di vita sostenibile.
                    </p>
                    <h3 className='font-bold text-[22px] lg:text-[28px] pt-4'>Vision</h3>
                    <p className='text-[18px] lg:text-[20px]'>
                        Proporti prodotti di qualità, adatti a tutti i tuoi bisogni ed esigenze con particolare attenzione alla produzione 100% sostenibile, senza compromessi. 
                ...
                <div className='flex items-center justify-between lg:justify-center gap-2 lg:gap-56'>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        <p className='font-black text-[100px] tracking-wide'>150<span className='text-[40px]'>t</span></p>
